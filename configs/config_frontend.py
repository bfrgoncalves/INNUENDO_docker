...
#CURRENT_ROOT = 'http://localhost:5000/'
#TORRE
...
database_uri = 'postgresql://'+DATABASE_USER+':'+DATABASE_PASS+'@db_mlst/mlst_database'
innuendo_database_uri = 'postgresql://'+DATABASE_USER+':'+DATABASE_PASS+'@db_innuendo/innuendo'
...
metadata_to_use_yersinia = {'FILE': 'strainID', 'Source': 'source_Source', 'Country': 'Location', 'Serotype': 'Serotype', 'Pathotype': 'Pathotyping', 'ST': 'ST'}
base_metadata = {'strainID':"", "source_Source":"", "Location":"", "Serotype":"", "Pathotyping":"", "ST":""}

wg_index_correspondece = {"E.coli":"./chewbbaca_database_profiles/indexes/ecoli_wg", "Yersinia": "./chewbbaca_database_profiles/indexes/yersinia_wg", "Salmonella": "./chewbbaca_database_profiles/indexes/salmonella_wg"}
core_index_correspondece = {"E.coli":"./chewbbaca_database_profiles/indexes/ecoli_core", "Yersinia": "./chewbbaca_database_profiles/indexes/yersinia_core", "Salmonella": "./chewbbaca_database_profiles/indexes/salmonella_core"}

wg_headers_correspondece = {"E.coli":"./chewbbaca_database_profiles/profiles_headers/ecoli_headers_wg.txt", "Yersinia": "./chewbbaca_database_profiles/profiles_headers/yersinia_headers_wg.txt", "Salmonella": "./chewbbaca_database_profiles/profiles_headers/salmonella_headers_wg.txt"}
core_headers_correspondece = {"E.coli":"./chewbbaca_database_profiles/profiles_headers/ecoli_headers_core.txt", "Yersinia": "./chewbbaca_database_profiles/profiles_headers/yersinia_headers_core.txt", "Salmonella": "./chewbbaca_database_profiles/profiles_headers/salmonella_headers_core.txt"}

core_increment_profile_file_correspondece = {"E.coli":"./chewbbaca_database_profiles/indexes/ecoli_core_profiles.tab", "Yersinia": "./chewbbaca_database_profiles/indexes/yersinia_core_profiles.tab", "Salmonella": "./chewbbaca_database_profiles/indexes/salmonella_core_profiles.tab"}
wg_increment_profile_file_correspondece = {"E.coli":"./chewbbaca_database_profiles/indexes/ecoli_wg_profiles.tab", "Yersinia": "./chewbbaca_database_profiles/indexes/yersinia_wg_profiles.tab", "Salmonella": "./chewbbaca_database_profiles/indexes/salmonella_wg_profiles.tab"}

classification_levels = {"E.coli":[7, 112], "Yersinia":[7, 133], "Salmonella":[7, 338], "Campylobacter":[4, 59]}
##################  agraph  ############################################
