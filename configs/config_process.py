...
CHEWBBACA_SCHEMAS_PATH = '/home/ubuntu/innuendo/chewBBACA_schemas'
CHEWBBACA_CORRESPONDENCE = {"E.coli": "Escherichia coli"}
MLST_CORRESPONDENCE = {"E.coli": "ecoli"}

SEQ_FILE_O = {"E.coli":"/mnt/singularity_cache/shared_files/Ecoli/O_type.fasta"}
SEQ_FILE_H = {"E.coli":"/mnt/singularity_cache/shared_files/Ecoli/H_type.fasta"}
...
core_headers_correspondece = {"E.coli":"/home/ubuntu/innuendo/INNUENDO_PROCESS_CONTROLLER/chewBBACA_core_files/ecoli/ecoli_headers_core.txt"}
...
species_expected_genome_size = {"E.coli": "5", "Yersinia": "4.7"}
##################  agraph  ############################################
